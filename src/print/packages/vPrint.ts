import VuePrintLast from "./VuePrintLast";
...
const vPrint = {
  ...
  mounted(
    el: HTMLElement,
    binding: DirectiveBinding<PrintAreaOption | string | undefined>
  ) {
    ...
    addEvent(el, "click", () => {
      ...
      new VuePrintLast({ ...options, el: printElement, vue: binding.instance });
    });
  },
  // 兼容 Vue2 指令挂载
  bind(
